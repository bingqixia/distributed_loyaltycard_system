package com.group6.loyaltycard.api.user.api.feign;

import com.group6.loyaltycard.api.user.api.entity.SysUser;
import com.group6.loyaltycard.api.user.api.feign.fallback.RemoteUserServiceFallbackImpl;
 ...
 *
 */
@FeignClient(value = "lc-user-biz", fallback = RemoteUserServiceFallbackImpl.class)
